...
def train_model():
    ...
    model.classifier = nn.Linear(num_features, 2)  # Modify for binary classification
    ...
    model_save_dir = "DenseNet121_CXR14"
    ...
    metrics_df.to_csv(os.path.join(model_save_dir, 'DenseNet121_Metrics_CXR14.csv'), index=False)
