...
def initialize_model():
    ...
    model.classifier = nn.Sequential(
        nn.Dropout(0.5), # Drop out layer of 0.5
...
if __name__ == '__main__':
    ...
    metrics_df.to_csv('./MobileNetV2_CT_Scan/mobilenetv2_cv_metrics_CT.csv', index=False)
    print("Cross-validation metrics saved to 'mobilenetv2_cv_metrics_CT.csv'.")
    ...
    test_metrics_df.to_csv('./MobileNetV2_CT_Scan/mobilenetv2_test_metrics_CT.csv', index=False)
    print("Test metrics saved to 'mobilenetv2_test_metrics_CT.csv'.")
