...
def train_model():
    ...
    model.classifier[2] = nn.Linear(model.classifier[2].in_features, 2)  # Modify for binary classification
    ...
    model_save_dir = "ConvNeXtTiny_CXR14"
    ...
    metrics_df.to_csv(os.path.join(model_save_dir, 'ConvNeXtTiny_Metrics_CXR14.csv'), index=False)
