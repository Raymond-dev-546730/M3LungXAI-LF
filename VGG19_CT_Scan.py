...
def initialize_model():
    ...
    # Modified VGG19 model classifier to fit 4 classes
...
if __name__ == '__main__':
    ...
    metrics_df.to_csv('./VGG19_CT_Scan/densenet121_cv_metrics_CT.csv', index=False)
    print("Cross-validation metrics saved to 'vgg19_cv_metrics_CT.csv'.")
    ...
    test_metrics_df.to_csv('./VGG19_CT_Scan/vgg19_test_metrics_CT.csv', index=False)
    print("Test metrics saved to 'vgg19_test_metrics_CT.csv'.")
