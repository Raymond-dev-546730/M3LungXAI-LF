...
if __name__ == '__main__':
    ...
    metrics_df.to_csv('./ResNet50_CT_Scan/resnet50_cv_metrics_CT.csv', index=False)
    print("Cross-validation metrics saved to 'resnet50_cv_metrics_CT.csv'.")
    ...
    test_metrics_df.to_csv('./ResNet50_CT_Scan/resnet50_test_metrics_CT.csv', index=False)
    print("Test metrics saved to 'resnet50_test_metrics_CT.csv'.")
